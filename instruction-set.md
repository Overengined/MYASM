...
### Read `COPY <adress> <adress>` (2)

Copy the content of an adress to another.

### If `IFTH <value|adress> <logic> <value|adress> <flag>` (1)

Jumps to a specific flag if the logic evaluation is True. See [Logic](#logic)

### Print from adress `DSPR <adress>` (1)

Prints to the console the value at a specific adress.

### Print Immediate `DSPL <value>` (1)

### End of program `ENDP` (1)

Immediately stops the program

### Add from Adresses `RADD <adress> <adress> <adress>` (1)

writes the sum of two values at a specific adress.

### Add Immediate `IADD <value> <adress> <adress>` (1)

### Logic

These are the logic operators supported by MYASM

#### Greater than Adress `<adress> IAGT <adress>`

Is true when the value at the adress before is greater than the value at the adress after.

#### Greater than Immediate `<adress> IIGT <value>`

#### Equal Adress `<adress> IAEQ <adress>`

Is true when the two values are equal.

#### Equal Immediate `<adress> IIEQ <value>`
